	...
	grunt.initConfig( {
		...
		compress: {
			main: {
				options: {
					archive:
						'md-ai-content-writer-<%= pkg.version %>.zip',
					mode: 'zip',
				},
				files: [
					{
						src: [ './md-ai-content-writer/**' ],
					},
				],
			},
		},
		clean: {
			main: [ './md-ai-content-writer' ],
			zip: [ '*.zip' ],
		},
		makepot: {
			target: {
				options: {
					domainPath: '/',
					mainFile: 'md-ai-content-writer.php',
					potFilename: 'languages/md-ai-content-writer.pot',
					potHeaders: {
						poedit: true,
		...
		addtextdomain: {
			options: {
				textdomain: 'md-ai-content-writer',
				updateDomains: true,
			},
			target: {
				files: {
		...
		strip_code: {
			strip_woo: {
				...
				src: [ './md-ai-content-writer/plugin-loader.php' ],
			},
		},
	} );
